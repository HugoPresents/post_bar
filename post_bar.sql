...
# Database: post_bar
# Generation Time: 2012-11-23 15:14:39 +0000
# ************************************************************
...
VALUES
	...
	(20,1,1,'你妹的，如果我再创建一个主题呢','你会不会给我涨一个？？？',1353221040,7,1,0);
...
INSERT INTO `user` (`id`, `name`, `email`, `password`, `gender`, `regist_time`, `signature`, `avatar`, `outsite_link`, `posts`, `money`, `node_favs`, `post_favs`, `user_favs`, `last_session_id`)
VALUES
	(1,'Rabbit_52','rabbitzhang52@gmail.com','a51e47f646375ab6bf5dd2c42d3e6181',1,1346419212,'兔子不舒服斯基','1.jpg',NULL,0,177.06,0,2,1,NULL),
