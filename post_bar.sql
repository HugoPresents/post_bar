...
# Database: post_bar
# Generation Time: 2012-11-24 17:24:10 +0000
# ************************************************************
...
INSERT INTO `post` (`id`, `user_id`, `node_id`, `title`, `content`, `time`, `views`, `comments`, `thanks`)
VALUES
	(1,1,1,'测试标题','测试内容哦！',0,124,8,0),
	...
	(17,1,1,'求助，if else 判断不正确~','这尼玛，坑爹呀',1349622259,32,19,0),
	(18,1,1,'阿宾额头和维特哈如果不','人工犬瘟热和企鹅天河区退还给',1349623884,5,1,1),
	(19,1,1,'阿宾额头和维特哈如果不','人工犬瘟热和企鹅天河区退还给',1349623893,8,0,1),
	(20,1,1,'你妹的，如果我再创建一个主题呢','你会不会给我涨一个？？？',1353221040,10,2,0);
...
VALUES
	(1,'Rabbit_52','rabbitzhang52@gmail.com','3995856b4b2dbd2d41c42543fa5cde65',1,1346419212,'兔子不舒服斯基','1.jpg',NULL,0,172.06,0,2,1,'yndzv'),
	...
	(3,'demo','demo@demo.com','eed7170200d71e81b73430b03317d6ac',1,1353777567,NULL,NULL,NULL,0,1995,0,0,0,'azngu');
